...
import presentador.PresentadorGestorProveedorMod;

/**
 *
 * @author USUARIO
 */
public class VistaModificarPro extends javax.swing.JFrame implements IGestionProveedorMod {
    private PresentadorGestorProveedorMod presentador;
    /**
     * Creates new form VistaRegistroPro
     */
    public VistaModificarPro() {
        initComponents();
        this.setLocationRelativeTo(null);
        presentador = new PresentadorGestorProveedorMod(this);
    ...
    @Override
    public void llenarVistaConDatos(Proveedor proveedor, Estado estado, Domicilio domicilio, Localidad localidad){
    ...
    public void cerrar(){
        VistaGestionProveedor gestionpro = new VistaGestionProveedor();
    ...
    private void initComponents() {
        ...
        lblTitulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/modificacion.png"))); // NOI18N
        ...
        getContentPane().add(lblCuit, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 160, -1, -1));

        lblEstado.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblEstado.setText("Estado:");
        getContentPane().add(lblEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 160, -1, -1));

        lblRazonSocial.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblRazonSocial.setText("Razón Social:");
        getContentPane().add(lblRazonSocial, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, -1, -1));

        lblPais.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblPais.setText("País:");
        getContentPane().add(lblPais, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 260, -1, -1));

        lblProvincia.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblProvincia.setText("Provincia:");
        getContentPane().add(lblProvincia, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, -1, -1));

        lblLocalidad.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblLocalidad.setText("Localidad:");
        getContentPane().add(lblLocalidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 310, -1, -1));

        lblCalle.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblCalle.setText("Calle:");
        getContentPane().add(lblCalle, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 360, -1, -1));

        lblNumero.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblNumero.setText("N°:");
        getContentPane().add(lblNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 360, -1, -1));

        lblTelefono.setFont(new java.awt.Font("Microsoft JhengHei Light", 1, 14)); // NOI18N
        lblTelefono.setText("Teléfono:");
        getContentPane().add(lblTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 410, -1, -1));
        ...
        getContentPane().add(btnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(525, 460, 130, -1));

        txtCuit.setFont(new java.awt.Font("Microsoft JhengHei Light", 0, 14)); // NOI18N
        getContentPane().add(txtCuit, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 210, 30));
        ...
        getContentPane().add(cmbPais, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 210, 30));
        ...
        getContentPane().add(cmbLocalidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 300, 500, 30));

        txtCalle.setFont(new java.awt.Font("Microsoft JhengHei Light", 0, 14)); // NOI18N
        getContentPane().add(txtCalle, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 390, 30));

        txtNumero.setFont(new java.awt.Font("Microsoft JhengHei Light", 0, 14)); // NOI18N
        getContentPane().add(txtNumero, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 350, 90, 30));

        txtRazonSocial.setFont(new java.awt.Font("Microsoft JhengHei Light", 0, 14)); // NOI18N
        getContentPane().add(txtRazonSocial, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 480, 30));
        getContentPane().add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 360, 30));
        ...
        getContentPane().add(cmbProvincia, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 252, 230, 30));
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 530, 80, -1));
        ...
        getContentPane().add(btnAtras, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 530, -1, -1));

        lblFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondo.jpg"))); // NOI18N
        getContentPane().add(lblFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 740, 610));
    ...
    private void btnRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegistrarMouseClicked
        ...
        try {
            ...
            presentador.actualizarProveedor(cuit, razonSocial, telefono, calle, numero, localidad, estado);
        } catch(Exception e) {
            this.mostrarMje("Error en uno o mas campos");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaModificarPro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaModificarPro().setVisible(true);
            }
        });
    }
