...
import presentador.PresentadorGestorProveedorAg;

/**
 *
 * @author USUARIO
 */
public class VistaRegistroPro extends javax.swing.JFrame implements IGestionProveedorAg {
    private PresentadorGestorProveedorAg presentador;
    /**
     * Creates new form VistaRegistroPro
     */
    public VistaRegistroPro() {
        initComponents();
        this.setLocationRelativeTo(null);
        presentador = new PresentadorGestorProveedorAg(this);
    ...
    private void initComponents() {
        ...
        lblTitulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/registro.png"))); // NOI18N
        getContentPane().add(lblTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, -1, -1));
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 530, 80, -1));
        ...
        getContentPane().add(btnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 450, 130, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 530, 80, -1));
    ...
    private void btnRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegistrarMouseClicked
        ...
        try {
            ...
            presentador.registrarProveedor(cuit, razonSocial, telefono, calle, numero, localidad, estado);
        } catch(Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaRegistroPro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaRegistroPro().setVisible(true);
            }
        });
    }
